                ...
                handleMousemove: function (t) {
                    if (this.mousedown) {
                        var e = "ontouchstart" in window ? t.touches[0].clientX : t.clientX,
                            n = this.dragStartX - e;
                        this.dragOffset = n, this.dragOffset > this.minSwipeDistance ? (this.handleMouseup(), this.goPrev()) : this.dragOffset < -this.minSwipeDistance && (this.handleMouseup(), this.goNext())
                    }
                },
